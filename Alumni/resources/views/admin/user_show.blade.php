    ...
    <table class="table table-light table-striped table-hover shadow rounded">
        <tbody class="table-borderless">
            ...
            <tr>
                <th>LinkedIn</th>
                <td>
                    <a href='http://{{ $user->profile->url_linkedin }}'
                        target="_blank">{{ $user->profile->url_linkedin }}</a>
                </td>
            </tr>
            <tr>
                <th>GitHub</th>
                <td><a href='http://{{ $user->profile->url_github }}'
                        target="_blank">{{ $user->profile->url_github }}</a></td>
            </tr>
            <tr>
                <th>Website</th>
                <td><a href='http://{{ $user->profile->url_website }}'
                        target="_blank">{{ $user->profile->url_website }}</a> </td>
            </tr>
            <tr>
                <th>Profile Image</th>
